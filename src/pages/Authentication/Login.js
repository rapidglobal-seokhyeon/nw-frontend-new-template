...
const Login = props => {
  ...
  document.title = "낭만웨딩 로그인 페이지 | Nangman Wedding - SignIn Page";
  return (
    <React.Fragment>
      <ParticlesAuth>
            ...
            <Row>
              <Col lg={12}>
                <div className="text-center mt-sm-5 mb-4 text-white-50">
                  ...
                  <p className="mt-3 fs-15 fw-medium">낭만웨딩 로그인</p>
                </div>
              </Col>
            </Row>
                ...
                <Card className="mt-4">
                  <CardBody className="p-4">
                    <div className="text-center mt-2">
                      <h5 className="text-primary">방문해주셔서 감사합니다 !</h5>
                      <p className="text-muted">로그인해서 낭만웨딩을 즐겨보세요 !</p>
                    </div>
