...
const Cuesheet = () => {
  const dispatch = useDispatch();
    ...
    console.log("qsheetlist",qsheetLists)
        ...
        <React.Fragment>
            ...
            <Row className="g-4 mb-3">
                <div className="col-sm-auto">
                    <div>
                        <Link to="/qsheet-create" className="btn btn-success"><i
                            className="ri-add-line align-bottom me-1"></i> 새로 만들기</Link>
                    </div>
                </div>
                <div className="col-sm-3 ms-auto">
                    <div className="d-flex justify-content-sm-end gap-2">
                        ...
                        <select className="form-control w-md" data-choices data-choices-search-false>
                            ...
                            <option value="Yesterday" defaultValue>어제</option>
                        </select>
                    </div>
                </div>
            </Row>
                                        ...
                                        <div className="d-flex flex-column h-100">
                                            <div className="d-flex" >
                                                <div className="flex-grow-1">
                                                    <p className="text-muted mb-4">{item.created_at}</p>
                                                </div>
                                                    ...
                                                    <div className="d-flex gap-1 align-items-center">
                                                        ...
                                                        <UncontrolledDropdown direction='start'>
                                                            ...
                                                            <DropdownMenu className="dropdown-menu-end">
                                                                <DropdownItem href="apps-projects-overview"><i className="ri-eye-fill align-bottom me-2 text-muted"></i> 보기</DropdownItem>
                                                                <DropdownItem href="apps-projects-create"><i className="ri-pencil-fill align-bottom me-2 text-muted"></i> 수정</DropdownItem>
                                                                <div className="dropdown-divider"></div>
                                                                <DropdownItem href="#" onClick={() => onClickData(item)} data-bs-toggle="modal" data-bs-target="#removeProjectModal"><i className="ri-delete-bin-fill align-bottom me-2 text-muted"></i> 삭제</DropdownItem>
                                                            </DropdownMenu>
                                            ...
                                            <div className="d-flex mb-2">
                                                <div className="flex-grow-1">
                                                    ...
                                                    <div>
                                                      ...
                                                      <div className="fs-12 badge bg-waring-subtle">{item.org_confirm}</div>
                                                    </div>
                                                </div>
                                        ...
                                        <div className="d-flex align-items-center">
                                            <div className="flex-shrink-0">
                                                <div className="text-muted">
                                                    <i className="ri-calendar-event-fill me-1 align-bottom"></i> {item.created_at}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
